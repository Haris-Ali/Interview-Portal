...
const userCtrl = {
    ...
    getinterviewer: async (req, res ) => {
            try {
                console.log("get-Interviewer")
    ...
    addpost: async (req,res) =>{
        try {
            const {title, salary, job_description, workhours} = req.body
            ...
            const post = new Post({
                title,salary,job_description,workhours,postedBy: mongoose.Types.ObjectId(interviewer._id)
            })
